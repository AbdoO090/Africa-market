                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            ...
                                            <div class="form-group">
                                                <h5><b>Governorate Select - اختر ألمحافظه</b> <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="exampleInputEmail1">Address in Details - العنوان بالتفصيل
                                                    <span>*</span></label>
                                ...
                                @endauth
                                        ...
                                        <li>
                                            @if (Session::has('coupon'))
                                                <strong>SubTotal: </strong> EGP{{ $total }}
                                                <hr>
                                                ...
                                                EGP{{ session()->get('coupon')['discount_amount'] }}
                                                <hr>

                                                <strong>Grand Total : </strong>
                                                EGP{{ session()->get('coupon')['total_amount'] }}
                                                <hr>
                                            @else
                                                <strong>SubTotal: </strong> EGP{{ $total }}
                                                <hr>

                                                <strong>Grand Total : </strong> EGP{{ $total }}
                                                <hr>
                                            @endif
