...
<!--  /////////// This is for Brand Filder /////////////// -->
 ...
 <label class="form-check-label">
  ...
  @if(session()->get('language') == 'arabic') {{ $brand->brand_name_ar }} @else {{ $brand->brand_name_en }} @endif
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-4 col-lg-4">
                    <div class="info-box">
                        ...
                        <h6 class="text">Sale OFF in many itrem</h6>
                    </div>
                </div>
                <!-- .col -->
            </div>
...
@if ($product->discount_price == NULL)
<div class="product-price"> <span class="price"> OMR{{ $product->selling_price }} </span>   </div>
@else
<div class="product-price"> <span class="price"> OMR{{ $product->discount_price }} </span> <span class="price-before-discount">OMR {{ $product->selling_price }}</span> </div>
@endif
