                                                     ...
                                                     <div class="form-group">
                                                         ...
                                                         <div class="controls">
                                                             ...
                                                             <input type="text" name="product_tag_ar"
                                                                 value="null" class="form-control"required=""
                                                                 data-role="tagsinput">
                                                     ...
                                                     <div class="form-group">
                                                         ...
                                                         <div class="controls">
                                                             <input type="text" name="product_tag_en"
                                                                 class="form-control"required=""
                                                                 value="null" data-role="tagsinput">
                                        ...
                                        Long Description Arabic
                                             ...
                                             <div class="row">
                                                 <div class="col-md-6">
                                                     ...
                                                     <div class="form-group">
                                                         ...
                                                         <div class="controls">
                                                             ...
                                                             <fieldset>
                                                                 <input type="checkbox" id="checkbox_3" name="feature"
                                                                      value="1">
                                                 ...
                                                 <div class="text-xs-right">
                                                     <input type="submit" class="mb-5 btn btn-rounded btn-primary"
                                                         value="Add Product">
                                                 </div>
                                 </form>
