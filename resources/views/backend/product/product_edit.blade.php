...
@section('admin')
    ...
    <div class="container-full">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 1st row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Counrty Select <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_ar" class="form-control"
                                                            required="" value="{{ $products->product_name_ar }}">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="product_tag_ar"
                                                            value="{{ $products->product_tag_ar }}"
                                                            class="form-control"required="" data-role="tagsinput">
                                        ...
                                        <div class="row"> <!-- start 3RD row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_qyt" class="form-control"
                                                            required="" value="{{ $products->product_qyt }}">
                                        ...
                                        <div class="row"> <!-- start 4th row  -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_ar" class="form-control"
                                                             value="{{ $products->product_size_ar }}"
                                                            data-role="tagsinput">
                                            ...
                                            <div class="row"> <!-- start 7th row  -->
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Short Description Arabic <span class="text-danger">*</span>
                                                        </h5>
                                                        <div class="controls">
                                            ...
                                            <div class="row"> <!-- start 8th row  -->
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Long Description Arabic <span class="text-danger">*</span>
                                                        </h5>
                                                        <div class="controls">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="checkbox" id="checkbox_3" name="feature" value="1" {{ $products->feature == 1 ? 'checked': '' }}>
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <input type="checkbox" id="checkbox_4" name="special_offer" value="1" {{ $products->special_offer == 1 ? 'checked': '' }}>
                                                            ...
                                                            <fieldset>
                                                                    ...
                                                                    <input type="checkbox" id="checkbox_5" name="special_deal" value="1" {{ $products->special_deal == 1 ? 'checked': '' }}>
       ...
       <div class="card">
         <img src="{{ asset($img->product_photo) }}" class="card-img-top" style="height: 130px; width: 280px;">
         <div class="card-body">
           <h5 class="card-title">
